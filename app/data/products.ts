...
export const categories: Category[] = [
  ...
  },
  {
    ...
    products: [
      ...
      { id: "di-potassium-edta", name: "Di-Sodium EDTA", categoryId: "edta-chelated", description: "Di-Potassium EDTA is used as a chelating agent in industrial and agricultural applications.", applications: ["Chelating agent", "Industrial processing", "Agricultural formulations"], packaging: ["25 kg bag", "50 kg bag"], documentsAvailable: ["COA", "Product Catalogue"], relatedProducts: ["iron-edta", "special-grade-edta"] },
      ...
      { id: "calcium-magnesium-boron", name: "Calcium Magnesium Boron EDTA", categoryId: "edta-chelated", description: "A multi-micronutrient combination of calcium, magnesium, and boron for comprehensive crop nutrition via foliar or fertigation application.", applications: ["Multi-nutrient foliar spray", "Fertigation", "Deficiency correction for Ca, Mg, B"], packaging: ["25 kg bag", "50 kg bag"], documentsAvailable: ["COA", "Product Catalogue"], relatedProducts: ["boron-edta", "calcium-edta", "magnesium-edta"] },
      ...
      { id: "special-grade-edta", name: "Special Grade EDTA", categoryId: "edta-chelated", description: "Special Grade EDTA is a high-purity EDTA formulation for specific industrial, pharmaceutical, or agricultural requirements.", applications: ["Industrial chelation", "Pharmaceutical use", "Specialty agriculture"], packaging: ["25 kg bag", "50 kg bag"], documentsAvailable: ["COA", "Product Catalogue"], relatedProducts: ["chelated-edta"] },
    ],
  },
  {
    id: "fluoride-base",
  ...
  },
  {
    ...
    products: [
      { id: "phosphoric-acid", name: "Phosphoric Acid (75%, 80%, 85%, Technical)", categoryId: "acids", description: "Phosphoric Acid (H₃PO₄) supplied in 75%, 85%, and technical grades for fertilizer manufacturing, food processing, and industrial applications.", applications: ["Fertilizer manufacturing", "Food grade applications", "Metal surface treatment", "Industrial cleaning", "Water treatment"], packaging: ["35 kg carboy", "250 kg drum", "IBC tank", "Tanker"], documentsAvailable: ["COA", "MSDS", "Product Catalogue"], cas: "7664-38-2", specifications: { "Molecular Formula": "H₃PO₄", "Available Grades": "75%, 80%, 85%, Technical", "Appearance": "Clear colorless liquid" }, relatedProducts: ["sulfuric-acid", "nitric-acid"] },
      { id: "sulfuric-acid", name: "Sulfuric Acid (98%)", categoryId: "acids", description: "Sulfuric Acid (H₂SO₄) supplied in 70% and 98% concentration for industrial, fertilizer, and chemical manufacturing applications.", applications: ["Fertilizer manufacturing", "Battery electrolyte", "Chemical synthesis", "Metal processing", "Industrial cleaning"], packaging: ["250 kg drum", "IBC tank", "Tanker as per requirement"], documentsAvailable: ["COA", "MSDS", "Product Catalogue"], cas: "7664-93-9", specifications: { "Molecular Formula": "H₂SO₄", "Available Grades": "98%", "Appearance": "Colorless to slightly yellow liquid" }, relatedProducts: ["phosphoric-acid", "hydrochloric-acid"] },
