...
// Derived from app/data/products.ts so the menu can never fall out of sync
// with the real product categories.
const productCategories = categories.map((c) => ({ name: c.name, href: `/products/${c.slug}`, icon: c.icon }));
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center h-[68px]" style={{ gap: 0 }}>
          ...
          <div className="hidden lg:flex flex-1 items-center justify-center gap-1">
            ...
            <Link href="/social" className="nav-link px-3.5 py-2 rounded text-sm font-medium whitespace-nowrap">
              Social
            </Link>
          </div>
