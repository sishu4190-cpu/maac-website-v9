...
import { CheckCircle, Package, FileText, ArrowRight, FlaskConical, Phone } from "lucide-react";
...
export async function generateMetadata({ params }: { params: Promise<{ category: string; product: string }> }): Promise<Metadata> {
  ...
  return {
    title: `${product.name} | ${cat.name} Supplier, Vapi, Gujarat`,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={q} className="border border-gray-200 rounded-lg p-4">
                      <h3 className="font-bold text-sm mb-1.5" style={{ color: "#1a4d2e" }}>{q}</h3>
            ...
            <div className="space-y-5">
              ...
              <div className="p-5 rounded-xl border border-gray-200 bg-white">
                ...
                <ul className="space-y-1.5">
                  {product.documentsAvailable.map((doc) => (
