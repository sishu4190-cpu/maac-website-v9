...
import { FadeUp, SlideFromLeft, StaggerList, StaggerItem } from '@/app/components/animations';
              ...
              <StaggerList className="mt-8 space-y-4">
                {[
                  ...
                  <StaggerItem key={doc.label}>
                    <div className="flex items-center gap-3 p-4 rounded-xl border border-gray-100 card-hover" style={{ background: '#fafafa' }}>
