  ...
  return (
    <AdminShell title="Categories">
      <div style={{ maxWidth: 500, margin: "3rem auto", padding: "0 1rem", textAlign: "center" }}>
        ...
        <h1 style={{ fontSize: 20, fontWeight: 700, color: "#1a4d2e", marginBottom: 8 }}>Categories</h1>
        <p style={{ fontSize: 14, color: "#6b7280", marginBottom: 24, lineHeight: 1.6 }}>Manage the 10 product categories shown on the website.</p>
