  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f8f9fa" }}>
      <div style={{ background: "linear-gradient(135deg, #1a4d2e, #0f2d1a)", padding: "1rem 2rem", display: "flex", alignItems: "center", gap: 16 }}>
        ...
        <span style={{ color: "white", fontWeight: 600, fontSize: 15 }}>Security Settings</span>
      </div>
      <div style={{ maxWidth: 600, margin: "4rem auto", padding: "0 1.5rem", textAlign: "center" }}>
        <div style={{ fontSize: 48, marginBottom: 16 }}>🔐</div>
        <h1 style={{ fontSize: 24, fontWeight: 700, color: "#1a4d2e", marginBottom: 8 }}>Security Settings</h1>
        <p style={{ fontSize: 15, color: "#6b7280", marginBottom: 28, lineHeight: 1.6 }}>Change admin password, manage login credentials, and review security settings.</p>
